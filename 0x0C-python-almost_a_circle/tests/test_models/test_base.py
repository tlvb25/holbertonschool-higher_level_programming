...
class TestBaseToJSON(unittest.TestCase):
    ...
    def test_to_json_none(self):
        assert Base.to_json_string(None) == "[]"

    def test_to_json_empty(self):
        assert Base.to_json_string([]) == "[]"
    ...
    def test_to_json_two_dicts_rectangle(self):
        ...
        json_dictionary = Base.to_json_string([r1.to_dictionary(),
                                               r2.to_dictionary()])
        assert len(json_dictionary) == 112
    ...
    def test_to_json_three_dicts_rectangle(self):
        ...
        json_dictionary = Base.to_json_string([r1.to_dictionary(),
                                               r2.to_dictionary(),
                                               r3.to_dictionary()])
        assert len(json_dictionary) == 163
    ...
    def test_to_json_three_dicts_Square(self):
        ...
        json_dictionary = Base.to_json_string([r1.to_dictionary(),
                                               r2.to_dictionary(),
                                               r3.to_dictionary()])
        assert len(json_dictionary) == 117
...
class TestBaseJSONstringToDictionary(unittest.TestCase):
    ...
    def test_from_json_None(self):
        assert [], Base.from_json_string(None))

    def test_from_json_Empty(self):
        assert [], Base.from_json_string("[]"))
